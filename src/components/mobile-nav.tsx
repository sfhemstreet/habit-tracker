...
export function MobileNav({ onNewHabit }: { onNewHabit: () => void }) {
  ...
  return (
    <nav className="fixed inset-x-0 bottom-0 z-20 flex items-center justify-around border-t bg-[var(--card)] px-2 pb-[calc(env(safe-area-inset-bottom)+0.5rem)] pt-2 md:hidden">
